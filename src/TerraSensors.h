...
public:
    ...
    void setMeasurement(float value, Terra_Unit units,
...
public:
    TerraTemperatureSensor(tposi_t sensorIndex,
        ...
        : TerraAnalogSensor(Terra_SensorType_Temperature, sensorIndex, inputPin, Terra_Unit_Celsius) { ; }
};
...
public:
    TerraHumiditySensor(tposi_t sensorIndex,
                        TerraAnalogPin inputPin = TerraAnalogPin())
        : TerraAnalogSensor(Terra_SensorType_Humidity, sensorIndex, inputPin, Terra_Unit_Percent) { ; }
};
...
public:
    TerraLevelSensor(tposi_t sensorIndex,
                     TerraAnalogPin inputPin = TerraAnalogPin())
        : TerraAnalogSensor(Terra_SensorType_Level, sensorIndex, inputPin, Terra_Unit_Percent) { ; }
};
...
public:
    TerraPressureSensor(tposi_t sensorIndex,
                        TerraAnalogPin inputPin = TerraAnalogPin(),
                        Terra_Unit units = Terra_Unit_Kilopascals)
...
public:
    TerraWindSpeedSensor(tposi_t sensorIndex,
                         TerraAnalogPin inputPin = TerraAnalogPin())
        : TerraAnalogSensor(Terra_SensorType_WindSpeed, sensorIndex, inputPin, Terra_Unit_MetersPerSecond) { ; }
};
...
public:
    TerraWindDirectionSensor(tposi_t sensorIndex,
                             TerraAnalogPin inputPin = TerraAnalogPin())
        : TerraAnalogSensor(Terra_SensorType_WindDirection, sensorIndex, inputPin, Terra_Unit_Degrees) { ; }
};
...
public:
    TerraSolarRadiationSensor(tposi_t sensorIndex,
                              TerraAnalogPin inputPin = TerraAnalogPin())
        : TerraAnalogSensor(Terra_SensorType_SolarRadiation, sensorIndex, inputPin, Terra_Unit_WattsPerSquareMeter) { ; }
};
...
public:
    TerraVoltageSensor(tposi_t sensorIndex,
                       TerraAnalogPin inputPin = TerraAnalogPin())
        : TerraAnalogSensor(Terra_SensorType_Voltage, sensorIndex, inputPin, Terra_Unit_Volts) { ; }
};
...
public:
    TerraCurrentSensor(tposi_t sensorIndex,
                       TerraAnalogPin inputPin = TerraAnalogPin())
        : TerraAnalogSensor(Terra_SensorType_Current, sensorIndex, inputPin, Terra_Unit_Amps) { ; }
};
...
public:
    ...
    void receiveReport(float value, Terra_Unit units,
