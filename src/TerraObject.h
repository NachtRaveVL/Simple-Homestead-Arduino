...
// Simple class for referencing an object in the Terraduino system.
// This class is mainly used to simplify object key generation, which is used when we
// want to uniquely refer to objects in the Terraduino system.
struct TerraIdentity {
...
// Object Base
// A simple base class for referring to objects in the Terraduino system.
...
protected:
    ...
    virtual TerraData *allocateData() const;                // Only up to base type classes (sensor, crop, etc.) does this need overriden
