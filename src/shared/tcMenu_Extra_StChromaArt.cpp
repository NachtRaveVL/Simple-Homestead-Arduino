...
#if defined(TERRA_USE_GUI) && (defined(ARDUINO_ARCH_MBED) || defined(ARDUINO_ARCH_STM32))
#include "TerraduinoUI.h"
#if (defined(TERRA_UI_ENABLE_STCHROMA_LDTC) || defined(TERRA_UI_ENABLE_BSP_TOUCH))
