...
enum Terra_String : uint16_t {
    ...
    TStr_Log_AssessmentSequence,                // " assessment sequence"
    TStr_Log_CalculatedPumping,                 // " pumping request:"
    TStr_Log_ConditioningSequence,              // " conditioning sequence"
    TStr_Log_DistributionSequence,              // " distribution sequence"
    TStr_Log_FillSequence,                      // " fill sequence"
    TStr_Log_HasBegan,                          // " has began"
    TStr_Log_HasDisabled,                       // " has disabled"
    TStr_Log_HasEnabled,                        // " has enabled"
    TStr_Log_HasEnded,                          // " has ended"
    TStr_Log_MeasuredPumping,                   // " pumping result:"
    TStr_Log_SettlingSequence,                  // " settling sequence"
    ...
    TStr_Log_Field_Time_Start,                  // "  Start time: "
